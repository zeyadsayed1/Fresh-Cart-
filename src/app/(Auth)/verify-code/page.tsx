...
const STEPS = [
  ...
  { Icon: IconKey,  active: true,  completed: false },
  { Icon: IconLock, active: false, completed: false },
];
        ...
        return (
          <React.Fragment key={i}>
            ...
            >
              ...
              <step.Icon className={`${step.Icon === Check ? "w-[18px] h-[18px]" : "w-[16px] h-[16px]"}`} strokeWidth={step.Icon === Check ? 3 : 2} />
            </div>
  ...
  return (
    <div className="relative mt-1 mb-2">
      <input
        ...
        placeholder="•   •   •   •   •   •"
        maxLength={6}
        className="w-full text-center tracking-[16px] sm:tracking-[24px] text-gray-400 font-bold placeholder-[#9ca3af] placeholder:text-[24px] py-4 sm:py-5 rounded-xl border border-gray-200 focus:outline-none focus:ring-1 focus:ring-[#16A34A] focus:border-[#16A34A] transition-all bg-white"
        style={{ textIndent: '12px' }}
      />
      

      <div className="absolute -bottom-2 -left-3 bg-white pr-1">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="#9ca3af" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 22C12 22 20 18 20 12V5L12 2L4 5V12C4 18 12 22 12 22Z" fill="#9ca3af" fillOpacity="0.2" stroke="#9ca3af" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M12 22C12 22 4 18 4 12V5L12 2V22Z" fill="#9ca3af"/>
        </svg>
      </div>
    </div>
  );
...
export default function VerifyCodePage() {
  const [email] = useState('usama.route@gmail.com');
        ...
        <div className="w-full lg:w-1/2 flex justify-center lg:justify-start px-4 sm:px-8 lg:px-0 lg:pl-16 py-8 sm:py-12 lg:pt-16 lg:pb-16 bg-white shrink-0 min-h-screen lg:min-h-0 items-center lg:items-start">
          <div className="w-full max-w-[460px] h-fit bg-white rounded-[24px] p-8 sm:p-10 shadow-[0_12px_45px_rgb(0,0,0,0.06)] border border-gray-100">
            ...
            <div className="text-center mb-8">
              ...
              <h2 className="text-[24px] font-bold text-[#1e293b] mt-4 mb-2">Check Your Email</h2>
            ...
            <form className="flex flex-col gap-6 mt-4">
              ...
              <div className="text-center mt-3 mb-1">
                <p className="text-[13px] text-gray-500 font-medium">
                  ...
                  <button type="button" className="text-[#16A34A] font-bold hover:underline bg-transparent border-none p-0 cursor-pointer">
                    Resend Code
                  </button>
                </p>
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-[#16A34A] hover:bg-[#15803d] text-white py-3.5 rounded-xl font-bold text-[15px] flex items-center justify-center gap-2 transition-colors shadow-[0_4px_14px_rgba(22,163,74,0.25)]"
              >
                Verify Code
              </button>
              ...
              <Link
                ...
                className="flex items-center justify-center gap-1.5 text-gray-500 font-semibold text-[14px] hover:text-gray-700 transition-colors mt-2"
              >
